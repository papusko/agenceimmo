 ...
 */
final class Version20190428150620 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_125BDA84FF7747B4 ON mobilier (titre)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_125BDA84FF7747B4 ON mobilier');
    }
}
